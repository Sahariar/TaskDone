<!-- ========== HEADER ========== -->
<header class="flex flex-wrap md:justify-between md:flex-nowrap z-48 w-full bg-white border-b border-gray-200 text-sm py-2.5  dark:bg-neutral-800 dark:border-neutral-700">
    <nav class="w-full px-4 sm:px-6 lg:px-8 flex basis-full items-center">
      <div class="w-full flex items-center justify-between ms-auto gap-x-1 md:gap-x-3">
        ...
        <div class="flex flex-row items-center justify-end gap-1">
          ...
          @if ($title == 'Tasks')
          <a href="#" title="Add Task" class="py-2 px-4 mx-2 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-teal-900 text-teal-800 hover:bg-teal-200 focus:outline-hidden focus:bg-teal-200 disabled:opacity-50 disabled:pointer-events-none dark:text-teal-500 dark:bg-teal-800/30 dark:hover:bg-teal-900/20 dark:focus:bg-teal-800/20">
        ...
        @else
        <a href="#" title="Add Project" class="py-2 px-4 mx-2 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-teal-900 text-teal-800 hover:bg-teal-200 focus:outline-hidden focus:bg-teal-200 disabled:opacity-50 disabled:pointer-events-none dark:text-teal-500 dark:bg-teal-800/30 dark:hover:bg-teal-900/20 dark:focus:bg-teal-800/20">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
            </svg>
        </a>
